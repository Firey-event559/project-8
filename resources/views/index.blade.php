<x-layout>
  ...
  <div class="container overflow-hidden text-center">
    <div class="row gx-5">
      <div class="col">
        <p class="p-3">Welkom bij Uneed-it, uw vertrouwde partner voor al uw reparatiebehoeften. Bij Uneed-it streven
      ...
      <div class="col">
        <div class="p-3"><img src="{{ Vite::asset('resources/assets/background2.png') }}" width="400px" height="300px">
        </div>
      </div>
    </div>
  </div>
