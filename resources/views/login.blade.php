        ...
        <main class="main-content">
            <div class="form-container">
                ...
                <div class=" alert alert-danger" role="alert">
                    ...
                    <input type="text" class="" name="email" id="email" placeholder="Email" value="{{ old('email') }}"
                        required><br>
                    @error('email')
                    <span style="color: red;">{{$message}}</span> @enderror
                    <label for="password"></label>
                    <input type="password" class="" name="password" id="password" placeholder="Wachtwoord"
                        value="{{ old('password') }}" required><br>
                    @error('password')
                    <span style="color: red;">{{$message}}</span><br> @enderror
                    <div class="register_href">
                        <p>Heb je geen account?
                            <a href="{{url('signup')}}">Registreren</a>
                        </p>
                    </div>
